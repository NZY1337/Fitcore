...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Sentio - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Sentio - React.js Tailwind CSS Admin Dashboard Template"
      />
